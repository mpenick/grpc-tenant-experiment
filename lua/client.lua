...
local semaphore = require("semaphore").new
...
_M.init = function(options)
  ...
  if ((type(hostsfile) == "string") and (false) or
    ...
    log(DEBUG, PREFIX, "Hosts file not found: "..tostring(hostsfile))
    hosts = {}
  end
  ...
  if ((type(resolvconffile) == "string") and false or
    ...
    log(DEBUG, PREFIX, "Resolv.conf file not found: "..tostring(resolvconffile))
    resolv = {}
  end
